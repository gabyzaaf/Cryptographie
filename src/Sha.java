...
public class Sha {
	...
	public static String createTheHashFromString(String message)throws  Exception, NoSuchAlgorithmException{
		try {
	...
	public static String createTheHashFromFile(String pathFile) throws Exception{
